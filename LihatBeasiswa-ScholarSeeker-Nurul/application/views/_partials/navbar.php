        ...
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-dark navbar-expand-lg">
                    <a class="navbar-brand" href="<?= base_url() ?>"><img src="<?= base_url('assets/img/logo-ss.png'); ?>" alt="logo" height="50"></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <ul class="navbar-nav ml-auto">
                            ...
                            $scholar = site_url('Beasiswa');
                            $news = site_url('Berita/daftarBerita');
                            $status = "SIGN IN";
                            $link_button = site_url('Landing/login');
                            ?>
                            <li class="nav-item"> <a class="nav-link" href="<?= $home ?>">HOME <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link <?php if($this->uri->uri_string() == 'Beasiswa') { echo 'active'; } ?>" href="<?= $scholar ?>">SCHOLAR</a> </li>
                            <li class="nav-item"> <a class="nav-link <?php if($this->uri->uri_string() == 'Berita/daftarBerita') { echo 'active'; } ?>" href="<?= $news ?>">NEWS</a> </li>
                            <?php
