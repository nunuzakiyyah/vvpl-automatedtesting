...
<body class="light-bg">
    ...
    <div class="container " style="margin-top:100px">
        ...
        <hr>
        <!-- Fitur selanjutnya
        <a class="btn btn-primary" href=""><i class="fas fa-lock"></i> Ubah Password</a> -->
    <div>
    ...
    <div class="container" style="margin-top:30px">
        ...
        <div class="row">
            <div class="col-sm-3 text-center">
                <img src="<?= base_url('upload/avatar/'.$profile->avatar) ?>" class="img-circle img-thumbnail bg-transparent" alt="avatar" width="300px" style="border: none;">
            </div>
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 col-md-2 col-5">
                                        <label style="font-weight:bold;">Institusi</label>
                                    </div>
                                    <div class="col-md-8 col-6">
                                        <?= $profile->institusi ?>
                                    </div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form action="<?= site_url('Pendonor/editProfile/')?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="formGroupExampleInput1">Institusi</label>
